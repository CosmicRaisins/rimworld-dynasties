...
namespace SZ.PawnComps
{
    public class CompThoughtProjector : ThingComp
    {
        ...
        public CompProperties_ThoughtProjector Props
        {
            get
            {
                return (CompProperties_ThoughtProjector)this.props;
            }
        }
